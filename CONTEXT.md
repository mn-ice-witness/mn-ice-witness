...
### Incident Data Files (Auto-Generated)
**NEVER edit these files directly** - they are auto-generated by `scripts/generate_summary.py` via pre-commit hook:
...
├── scripts/
│   ├── generate_summary.py   # Creates category JSON files + search-index.md

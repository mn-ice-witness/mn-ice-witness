...
date: 2025-12-09
time: afternoon
location: Cedar Avenue and Sixth Street South, Cedar-Riverside
city: Minneapolis
type: observers
status: resolved
...
## Summary
An ICE vehicle struck a protester in Minneapolis' Cedar-Riverside neighborhood during a confrontation between federal agents and community members. Video captured by journalist Jon Farina shows the collision and an ICE agent laughing "Hahaha! Wipe out!" afterward. The incident occurred during the same enforcement action that led to the wrongful detention of U.S. citizen Mubashir.

## Sources
1. Status Coup Substack (Dec 9, 2025): [BREAKING: ICE RUNS OVER Protester in Blizzard, Sadistically Laughs "WIPE OUT"](https://www.statuscoupsubstack.com/p/breaking-ice-runs-over-protester)
...
- **Citizenship:** Unknown
- **Injuries:** Knocked to ground by vehicle; extent of injuries not reported

## Timeline
- **Afternoon** - ICE agents conduct operations in Cedar-Riverside, asking residents for IDs and proof of citizenship.
- **Community response** - Crowd gathers, surrounding ICE vehicles as agents attempt to leave.
- **Confrontation** - Protesters blow whistles, yell at agents, and honk car horns.
- **Pepper spray** - ICE agents spray protesters from inside their vehicles.
- **Vehicle strike** - An unmarked ICE vehicle strikes a demonstrator, knocking them to the ground.
- **Agent reaction** - An ICE agent is heard laughing "Hahaha! Wipe out!" after the collision.
- **Escalation** - Protesters throw snowballs at ICE vehicles; agents exit and spray nearby demonstrators.

## Witness Accounts

**Andrew Hinrichs (witness):**
...
- The moment the ICE vehicle struck the protester (approximately 2:52 into footage)
- An agent's voice laughing "Hahaha! Wipe out!"
- Agents spraying pepper spray from vehicle windows
- Protesters throwing snowballs at approximately 3:00 mark

...
search_tags: children, chemical-agents, src:star-tribune, src:other-local
---
...
The canister was initially identified on social media as hexachloroethane (HC), a toxic military smoke agent. Three munitions experts later identified it as a Defense Technology "Pocket Tactical Green Smoke" grenade — a colored smoke device using terephthalic acid rather than hexachloroethane.
...
- Agents fired multiple canisters of green smoke at Mueller Park.
- Smoke spread across the playground, through the park, and into residential blocks.
...
- Video shows Bovino ordering people to "get back" before deploying the canister.
- Observers were standing on public sidewalks filming, not blocking vehicles.
- The canister was thrown toward the park and playground, not into the street.
- Agents then walked onto public sidewalk and assaulted people recording.

## Background

Bovino serves as Border Patrol Commander at Large. A federal judge found him ["outright lying"](https://www.fox9.com/news/border-patrol-chief-was-outright-lying-about-previous-ice-surge) about use of force during the Chicago operation. Multiple sources have raised concerns about [chemical agent use in Minneapolis](https://www.minnpost.com/metro/2026/01/my-eyes-were-stinging-the-chemicals-used-by-ice-when-they-confront-protesters-tear-gas-minneapolis/). CS tear gas and OC pepper grenades were confirmed used across other Minneapolis operations during this period.

...
source:
---
John Biestman and his wife Janet Lee follow an ICE vehicle near Church of the Assumption in Richfield. Four unmarked cars box them in; agents point semiautomatic weapons in their faces. Biestman: "This is like Germany 1938." Across the street, a woman photographing the encounter also has weapons pointed at her. When a Richfield officer arrives, an agent tells her: "See what happens when you call the police? Nothing. They can't do shit to us." The couple become named plaintiffs in the ACLU's [federal lawsuit](/entry/2025-12-17-tincher-v-noem-aclu-lawsuit). For a list of all observer incidents, see [list/observers](/list/observers).
...
source:
---
The ACLU of Minnesota files [Tincher v. Noem](/entry/2025-12-17-tincher-v-noem-aclu-lawsuit), producing the only preliminary injunction against any aspect of Operation Metro Surge — barring agents from retaliating against, pepper spraying, or stopping people for watching them. The Eighth Circuit stays the order 10 days later, but the evidentiary record — more than 30 sworn declarations — exists permanently.
...
source:
---
The first use of lethal force during Operation Metro Surge. A DHS agent shoots at a man in his car in St. Paul after being struck by the vehicle.
...
source:
---
ICE agents enter Hennepin County Medical Center without a judicial warrant and shackle a patient to his hospital bed for 28 hours. After county commissioners confirm no warrant exists, agents are ordered to leave. Days later, DHS [subpoenas I-9 employment records](/entry/2026-01-08-hennepin-healthcare-i9-subpoena) for more than 7,000 Hennepin Healthcare employees — a move Commissioner Angela Conley calls "retaliatory." In the weeks ahead, a [man is detained driving his sick wife to the ER](/entry/2026-01-16-parral-ortiz-hospital-detention) and a [Libyan man seeking treatment is shackled despite a painful skin condition](/entry/2026-01-11-hani-duglof-medical), breaking a long-standing precedent against immigration enforcement at hospitals. For a list of all hospital and school incidents, see [list/schools-hospitals](/list/schools-hospitals).
...
source:
---
The first known detention of a child. Ten-year-old Elizabeth Caisaguano and her mother are seized by ICE agents on the way to school in Columbia Heights. Agents tell Elizabeth they'll drop her at school. They never do. Both are flown to the Dilley, Texas detention facility by day's end. She remains in detention for nearly a month — the first in a series of child detentions that drew international attention.
...
source:
---
Border Patrol agents descend on Roosevelt High School during dismissal, tackle people on school grounds, and deploy chemical irritants. A U.S. citizen special education assistant is detained. Minneapolis Public Schools cancels classes for the week. [Jesse Ventura visits the next day](/entry/2026-01-08-jesse-ventura-roosevelt) and calls ICE "the draft-dodging coward's Gestapo." For a list of all school and hospital incidents, see [list/schools-hospitals](/list/schools-hospitals).
...
---
date: 2026-01-09
title: Agent Knees Man in Face on Video
incident: 2026-01-09-juan-carlos-brutality
source:
---
Video captures Border Patrol agents pinning a man down while one agent knees him in the face at least five times on pavement near 22nd & Chicago in south Minneapolis. The footage becomes widely shared.
...
source:
---
U.S. citizens Brandon Sigüenza and Patty O'Keefe are detained 8 hours without charges while monitoring ICE activity. Agents interrogate them about protest organizers, offering deals in exchange for names. O'Keefe describes witnessing holding cells: "the screaming, wailing and pleading... will forever haunt me."
...
source:
---
Minnesota Attorney General Keith Ellison, Mayor Jacob Frey, and Mayor Kaohly Her file a lawsuit calling Operation Metro Surge a "federal invasion of the Twin Cities" and alleging systematic racial profiling. It is the first time a state has sued the federal government to halt an immigration operation.
...
source:
---
ICE agents smash the car window of Aliya Rahman, a 43-year-old U.S. citizen with a traumatic brain injury, and drag her out while she screams "I'm disabled!" Denied medical attention in custody, she loses consciousness in her cell before being hospitalized. The footage goes viral with millions of views; Rahman later testifies before Congress.
...
source:
---
In at least four separate encounters over three days, ICE agents invoke the [killing of Renee Good](/entry/2026-01-07-renee-good-shooting) to threaten observers. An agent asks [Abigail Salm](/entry/2026-01-09-abigail-salm-observer-detained): "Have y'all not learned from the last couple of days?" before threatening "a bullet in your skull." At the Whipple Federal Building, an agent tells a [detained Marine veteran](/entry/2026-01-11-skye-elizabeth-marine-veteran-detained): "This is why we killed that lesbian bitch." The pattern across different agents and locations suggests Good's death was used as a tool of intimidation.
...
source:
---
Four ICE agents eat lunch at El Tapatio, a family-owned Mexican restaurant in Willmar. That evening, they detain the owners — in the U.S. since 1989 — and a dishwasher near a Lutheran church. The incident exposed a broader pattern of arrests targeting workers in restaurants, food plants, and farms across Minnesota. For a list of all immigrant detention incidents, see [list/immigrants](/list/immigrants).
...
source:
---
The ACLU files [Hussen v. Noem](/entry/2026-01-15-hussen-v-noem-racial-profiling-lawsuit), a class action on behalf of U.S. citizens racially profiled during Operation Metro Surge. With more than 40 sworn declarations, the case produces the most comprehensive evidentiary record of the operation's impact on Somali and Latino communities.
...
source:
---
President Trump threatens to invoke the Insurrection Act to deploy military forces to Minneapolis if "corrupt politicians" don't "obey the law." The Pentagon places 1,500 active-duty troops on standby.

---
date: 2026-01-18
title: Hmong Elder Detained Shirtless in Freezing Cold
incident: 2026-01-18-saly-hmong-citizen-shirtless
source:
---
A naturalized U.S. citizen is dragged from his home shirtless in approximately 10-degree weather. Agents entered without a warrant and pointed a gun at his daughter-in-law. The incident demonstrates enforcement targeting citizens across multiple ethnic communities.
...
source:
---
DHS Secretary Kristi Noem tells CBS's "Face the Nation" that agents are targeting "criminals and rapists," denies use of pepper spray — then backtracks when shown video evidence. The claims are contradicted by the operation's record, which documents incidents involving U.S. citizens, legal residents, bystanders, and children. For a list of all official statements and responses, see [list/response](/list/response).
...
source:
---
Two-year-old Chloe Tipan and her father are detained near Powderhorn. A federal judge orders the toddler released by 9:30 PM; nineteen minutes later, ICE places both on a commercial flight to Texas, separating Chloe from her mother. With [Elizabeth Caisaguano](/entry/2026-01-06-elizabeth-caisaguano-detained) and [Liam Ramos](/entry/2026-01-20-liam-ramos-detained) already detained, three children under 10 are now in a Texas facility. Chloe is returned the following day, but her father remains in ICE custody.
...
---
date: 2026-01-24
title: ICU Nurse Alex Pretti Killed by CBP
...
source:
---
Chief Judge Patrick Schiltz finds ICE violated 96 court orders in January 2026 alone — likely more "than some federal agencies have violated in their entire existence." The ruling comes after Schiltz summoned ICE Acting Director Todd Lyons to explain why he should not be held in contempt.
